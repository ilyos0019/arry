...
// //   li.textContent = "yangi matm";
// //   ok.appendChild(li);
// //   console.log(bos);
// // });
// ///  1
// // let chq = document.querySelector("#bos");
// // let bos = document.querySelector(".active");

// // chq.addEventListener("click", () => {
// //   bos.textContent = "javascript zo'r";
// // });
...
// //    let list = document.querySelectorAll("#ok li");
// //      list.forEach((e) =>{
...
// // bos.addEventListener("click",handleClick);
